Animanga::Application.routes.draw do
  ...
  get '/mensajepersonals/:id/reply' => "mensajepersonals#reply", :as => :reply_mensajepersonal
  post '/mensajepersonals/:id/reply' => "mensajepersonals#save_reply", :as => :reply_mensajepersonal
  resources :puntajes
